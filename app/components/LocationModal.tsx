...
export default function LocationModal(props: LocationModalProps) {
  ...
  return (
    <div
      ...
      tabIndex={-1}
    >
      <div className="relative flex h-72 w-72 flex-col gap-4 rounded-lg bg-slate-900 p-4 xs:h-80 xs:w-80 xs:p-8 sm:h-[28rem] sm:w-[28rem] sm:gap-6">
        <Image
          src={props.activeStep.value.image}
          alt="..."
          width={1920}
          height={1080}
          className="h-52 w-72 rounded-lg sm:h-80 sm:w-96"
        />
